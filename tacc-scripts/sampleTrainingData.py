...
params_list_alt = [
    ...
    # ('Reno-10x', 5, 3, 'metro'),
    # ('Reno-10x', 2, 2, 'bus'),
    # ('Reno-10x', 1.5, 2, 'train'),
    # ('Cubic-10x', 0.9, 0.4, 'bus'),
    # ('Cubic-10x', 0.7, 0.8, 'metro'),
    # ('Cubic-10x', 0.5, 0.4, 'car'),
    # ('Cubic-10x', 0.8, 0.8, 'tram'),

    # ('Reno-25x', 1, 2, 'ferry'),
    # ('Reno-25x', 5, 3, 'metro'),
    # ('Reno-25x', 2, 2, 'bus'),
    # ('Reno-25x', 1.5, 2, 'train'),
    # ('Cubic-25x', 0.9, 0.4, 'bus'),
    # ('Cubic-25x', 0.7, 0.8, 'metro'),
    # ('Cubic-25x', 0.5, 0.4, 'car'),
    # ('Cubic-25x', 0.8, 0.8, 'tram')
]
params_list = [
    ('Reno', 1, 4, 'metro'),
    ('Reno', 5, 1.5, 'ferry'),
    ...
    # ('Reno-10x', 1, 4, 'metro'),
    # ('Reno-10x', 5, 1.5, 'ferry'),
    # ('Reno-10x', 2, 4, 'car'),
    # ('Reno-10x', 1.5, 4, 'tram'),
    # ('Cubic-10x', 0.9, 0.8, 'car'),
    # ('Cubic-10x', 0.8, 0.4, 'train'),
    # ('Cubic-10x', 0.7, 0.4, 'bus'),
    # ('Cubic-10x', 0.5, 0.8, 'ferry'),

    # ('Reno-25x', 1, 4, 'metro'),
    # ('Reno-25x', 5, 1.5, 'ferry'),
    # ('Reno-25x', 2, 4, 'car'),
    # ('Reno-25x', 1.5, 4, 'tram'),
    # ('Cubic-25x', 0.9, 0.8, 'car'),
    # ('Cubic-25x', 0.8, 0.4, 'train'),
    # ('Cubic-25x', 0.7, 0.4, 'bus'),
    # ('Cubic-25x', 0.5, 0.8, 'ferry')
]
