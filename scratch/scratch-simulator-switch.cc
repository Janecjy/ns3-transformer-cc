...
NS_LOG_COMPONENT_DEFINE("ScratchSimulatorSwitch");
...
//     TcpComposite::SetPolicy(tcpTypeId);
//     TcpComposite::SetFirstPar(firstPolicyFirstParam);
//     TcpComposite::SetSecondPar(firstPolicySecondParam);
// }
...
main(int argc, char* argv[])
{
    ...
    // NS_LOG_DEBUG("firstTcpTypeId: " << firstTcpTypeId.GetName());
